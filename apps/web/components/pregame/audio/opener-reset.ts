...
export const OPENER_RESET_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    {
      type: "speech",
      text: "No condemnation does not mean no consequences. If you turn it over, the puck still goes the other way. But it means the verdict on you was already settled at the cross.",
      speed: 1.1,
      instructions: NARRATIVE_INSTRUCTIONS,
    },
    { type: "silence", durationSec: 1 },
    ...
    {
      type: "speech",
      text: "So when the bad play happens, do not carry condemnation into the next one. Learn what you need. Drop what you do not.",
      speed: 1.1,
      instructions: NARRATIVE_INSTRUCTIONS,
    },
    { type: "silence", durationSec: 1 },
