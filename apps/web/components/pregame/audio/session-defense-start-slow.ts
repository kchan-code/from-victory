// Defense × I start slow
//
// A slow start for a D-man often means poor gap, late reads, and a grip-tight stick — the body needs to be reminded to skate first, react second.
//
...
export const SESSION_DEFENSE_START_SLOW_SCRIPT: AudioScript = {
  slug: "session-defense-start-slow",
  voice: "ash",
