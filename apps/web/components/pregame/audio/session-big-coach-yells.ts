...
export const SESSION_BIG_COACH_YELLS_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Their five just grabbed another offensive board. The coach turns and barks down the bench, loud enough for everyone. Soft screens. You're getting pushed around in there.", speed: 1.0, instructions: VISUALIZATION_INSTRUCTIONS },
    ...
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "You answer with your body. Set a screen that knocks him back. Hit first on the box out. Own the glass on the next possession.", speed: 1.0, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Speak the truth. The earful is real. It is not your identity. Reset and go again.", speed: 1.2, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    ...CLOSING,
  ],
};
