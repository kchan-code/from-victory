// Forward × I feel nervous
//
// Pre-game nerves aren't a hard moment that arrives mid-game — they're the body's state before the first shift. The reframe is 'this is energy, not a verdict.'
//
...
export const SESSION_FORWARD_NERVOUS_SCRIPT: AudioScript = {
  slug: "session-forward-nervous",
  voice: "ash",
