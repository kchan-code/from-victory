// Goalie × I miss a scoring chance
//
// Goalie 'missed chance' reframed — fanning on a poke check, missing an empty-net look, or not moving the puck on a chance. The false story is 'I cost us a goal.'
//
...
export const SESSION_GOALIE_MISSED_CHANCE_SCRIPT: AudioScript = {
  slug: "session-goalie-missed-chance",
  voice: "ash",
