// Forward × I take a bad penalty
//
// A bad penalty for a forward triggers shame plus the reflex to play timid the next shift, which kills puck pursuit and forecheck pressure.
//
...
export const SESSION_FORWARD_BAD_PENALTY_SCRIPT: AudioScript = {
  slug: "session-forward-bad-penalty",
  voice: "ash",
