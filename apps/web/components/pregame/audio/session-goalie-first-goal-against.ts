// Goalie × We give up the first goal
//
// First goal against on the goalie is the hardest version of this adversity — the body wants to over-commit on the next shot to make up for it, which opens up rebounds and second chances.
//
...
export const SESSION_GOALIE_FIRST_GOAL_AGAINST_SCRIPT: AudioScript = {
  slug: "session-goalie-first-goal-against",
  voice: "ash",
