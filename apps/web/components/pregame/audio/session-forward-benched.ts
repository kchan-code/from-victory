// Forward × I get benched
//
// A slow-erosion adversity — shifts go by, the door doesn't open, and the spiral is about role identity, not a single play.
//
...
export const SESSION_FORWARD_BENCHED_SCRIPT: AudioScript = {
  slug: "session-forward-benched",
  voice: "ash",
