...
export const OPENER_BB_BE_VOCAL_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    {
      type: "speech",
      text: "Out there, talking is competing. The loud player moves the defense a half-second before the offense does. Tonight, that's the job — be the one who talks.",
      speed: 1.0,
    ...
    {
      type: "speech",
      text: "And here is what Paul wrote in Romans 8. For everyone in Christ, there is now no condemnation. None. The verdict on you was settled at the cross — before you ever stepped on the floor.",
      speed: 1.0,
      instructions: NARRATIVE_INSTRUCTIONS,
    },
    { type: "silence", durationSec: 1.0 },
    ...
    {
      type: "speech",
      text: "So tonight, be the loud one. I got ball. Screen left. Shot. Free to be wrong, free to speak, free to make the play before it happens.",
      speed: 1.0,
      instructions: NARRATIVE_INSTRUCTIONS,
    },
    { type: "silence", durationSec: 1.0 },
