...
export const SESSION_BIG_START_SLOW_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "You take the tone back. Establish position early, beat him to the spot, and get the first hit on every box out. Set it from here.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
