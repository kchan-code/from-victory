...
export const CLIP_HM_BB_GUARD_TURNOVER_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "You are running the offense. You try to force a pass through traffic. They pick it off and go the other way for a layup.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    { type: "speech", text: "Feel what your body does. Jaw clenches. Legs go heavy on the backpedal. I can't be trusted with the rock.", speed: 1.1, instructions: HARD_MOMENT_NARRATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That turnover is over. Sprint back and lead the next possession.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Slow it down. Next possession, get the team into something simple.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Speak the truth. That turnover is over. Get back, get organized, and make the next simple play.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
};
...
export const CLIP_HM_BB_GUARD_MISSED_SHOT_SCRIPT: AudioScript = {
  ...
  segments: [
    { type: "speech", text: "Now rehearse the hard moment.", speed: 1.1, mark: { phase: "hardMoment" } },
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "You come off the screen wide open. Feet set, clean look, the shot you've made a thousand times. It rims out.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    { type: "speech", text: "Feel what your body does. Shoulders drop. A flush climbs up your neck. Now they'll sag off me. I'm not a shooter today.", speed: 1.1, instructions: HARD_MOMENT_NARRATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That shot is over. The next read is still yours.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "The read was right. Same shot, next time it's open. Don't shrink it, don't force a worse one.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That shot is gone. Stay ready for the next look.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
};
...
export const CLIP_HM_BB_GUARD_GOT_COOKED_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That drive is over. Get your feet set and take the next matchup.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    ...
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "They won that moment. They do not own the next one. Get your feet set and compete again.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
};
...
export const CLIP_HM_BB_GUARD_FOUL_TROUBLE_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Those whistles are over. Defend with your feet and stay in control.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    ...
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "The whistle happened. Learn from it, then compete the next possession clean.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
};
...
export const CLIP_HM_BB_GUARD_COACH_YELLS_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That correction is over. Take the read and come back to now.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "The correction is about the read, not about you. Take it, slow the game down, and get the team into the next action.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
  ],
};
...
export const CLIP_HM_BB_GUARD_BENCHED_SCRIPT: AudioScript = {
  ...
  segments: [
    { type: "speech", text: "Now rehearse the hard moment.", speed: 1.1, mark: { phase: "hardMoment" } },
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "After a turnover, coach calls your number. You come out, and the backup brings the ball up. You watch the offense run without you.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    { type: "speech", text: "Feel what your body does. Heat in your chest. Tight in your throat. And the thought lands. They don't trust me to run it.", speed: 1.1, instructions: HARD_MOMENT_NARRATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Stay in the game from here. Watch their guard, talk, and be ready to organize.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "The bench has your body for a stretch. It does not have your mind. Watch their guard, talk from the sideline, and be ready to organize the next possession.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
  ],
};
...
export const CLIP_HM_BB_GUARD_NERVOUS_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Come back to your breath. Come back to the ball.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
...
export const CLIP_HM_BB_GUARD_MISSED_FTS_SCRIPT: AudioScript = {
  ...
  segments: [
    { type: "speech", text: "Now rehearse the hard moment.", speed: 1.1, mark: { phase: "hardMoment" } },
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "Tight game, late. You're at the line to ice it. The gym goes quiet. First one is short. Second one clanks off the front rim.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    { type: "speech", text: "Feel what your body does. Stomach sinks. Ears ringing in the quiet. I'm the guard, I'm supposed to close.", speed: 1.1, instructions: HARD_MOMENT_NARRATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Those free throws are over. Get back and guard the next possession.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Get back on defense. Next time at the line, same routine. Breathe, eyes on the rim, shoot it the way you always do.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Those shots are gone. Trust your routine on the next ones.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
};
...
export const CLIP_HM_BB_GUARD_START_SLOW_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "The slow start is over. Let the offense breathe from this possession.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
...
export const CLIP_HM_BB_GUARD_FALL_BEHIND_EARLY_SCRIPT: AudioScript = {
  ...
  segments: [
    { type: "speech", text: "Now rehearse the hard moment.", speed: 1.1, mark: { phase: "hardMoment" } },
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "They go on a quick run. You're down early, and you can feel the whole team look to you to stop the bleeding.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    { type: "speech", text: "Feel what your body does. Shoulders climb toward your ears. A weight settles across your back. This whole deficit is on me to fix.", speed: 1.1, instructions: HARD_MOMENT_NARRATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That run is over. Lead this possession.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "You don't owe them the whole deficit. You owe them the next possession. One stop. One good look. One at a time.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Speak the truth. The deficit is real. It is not yours alone to carry, and it is not who you are. Reset and go again.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
};
...
export const CLIP_HM_BB_WING_TURNOVER_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That turnover is over. Sprint back, then cut hard and show your hands.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
...
export const CLIP_HM_BB_WING_MISSED_SHOT_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That shot is over. Relocate and be ready for the next one.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
...
export const CLIP_HM_BB_WING_GOT_COOKED_SCRIPT: AudioScript = {
  ...
  segments: [
    { type: "speech", text: "Now rehearse the hard moment.", speed: 1.1, mark: { phase: "hardMoment" } },
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "You're on their best scorer. You close out, he rips by you, and finishes over the help. The bench reacts. That one's on the highlight.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    { type: "speech", text: "Feel what your body does. Heat floods your face. Your feet feel stuck to the floor. I'm a liability.", speed: 1.1, instructions: HARD_MOMENT_NARRATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That closeout is over. Get your stance back and take the matchup again.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "One beat doesn't make you a liability. Get into your stance, take the matchup again, and contest the very next closeout.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Speak the truth. Getting beat on one closeout is real. It does not make you a liability, and it is not who you are. Reset and go again.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
};
...
export const CLIP_HM_BB_WING_FOUL_TROUBLE_SCRIPT: AudioScript = {
  ...
  segments: [
    { type: "speech", text: "Now rehearse the hard moment.", speed: 1.1, mark: { phase: "hardMoment" } },
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "Two quick hand-check fouls on a faster guy. The whistle keeps finding you. You feel the bench getting close.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    { type: "speech", text: "Feel what your body does. Arms freeze at your sides. A flicker of panic before every closeout. I can't even guard anymore.", speed: 1.1, instructions: HARD_MOMENT_NARRATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Those whistles are over. Defend smarter and stay in front.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Don't back off — defend smarter. Move your feet, stay in front, hands up and back, and contest straight up without reaching.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "The whistle happened. Learn from it, then compete the next possession clean.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
...
export const CLIP_HM_BB_WING_COACH_YELLS_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That correction is over. Take the note and come back to now.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Coach is correcting the play, not naming you. Take the note, close out hard, and shoot the next open one free.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
  ],
};
...
export const CLIP_HM_BB_WING_BENCHED_SCRIPT: AudioScript = {
  ...
  segments: [
    { type: "speech", text: "Now rehearse the hard moment.", speed: 1.1, mark: { phase: "hardMoment" } },
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "Your shot isn't falling, so coach pulls you. You sit down at the end of the bench and watch the game go on without you.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    { type: "speech", text: "Feel what your body does. A hollow drop behind your ribs. Your gaze fixed on the floor in front of the bench. I'm only as good as my last make.", speed: 1.1, instructions: HARD_MOMENT_NARRATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Stay in the game from here. Stay connected, talk, and be ready when your name is called.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "The bench has your body for a stretch. It does not have your mind. Stay connected, talk on defense, and be ready when your name is called.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
  ],
};
...
export const CLIP_HM_BB_WING_NERVOUS_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Come back to your breath. Come back to your spot.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
...
export const CLIP_HM_BB_WING_MISSED_FTS_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Those free throws are over. Trust your routine and keep attacking.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
...
export const CLIP_HM_BB_WING_START_SLOW_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "The slow start is over. Get loud and earn the next touch.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
...
export const CLIP_HM_BB_WING_FALL_BEHIND_EARLY_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That run is over. Stay aggressive inside the offense.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
...
export const CLIP_HM_BB_BIG_TURNOVER_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That turnover is over. Sprint back, protect the paint, and ask for it again.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "You want the ball again. Seal your man, call for it, and roll hard into the next play.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Speak the truth. The turnover is real. It is not your identity. Reset and go again.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
...
export const CLIP_HM_BB_BIG_MISSED_SHOT_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That finish is over. Run the floor and get back to the glass.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    ...
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Speak the truth. The miss is real. Finishing is your job, not your worth, and it is not who you are. Reset and go again.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
};
...
export const CLIP_HM_BB_BIG_GOT_COOKED_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That switch is over. Get your base back and take the next matchup.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
...
export const CLIP_HM_BB_BIG_FOUL_TROUBLE_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Those whistles are over. Defend with your feet and stay in the game.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
...
export const CLIP_HM_BB_BIG_COACH_YELLS_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That correction is over. Take what helps and answer with your body.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Coach is correcting the possession, not naming you. Answer with your body — screen, box out, protect the paint.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
  ],
};
...
export const CLIP_HM_BB_BIG_FOULED_OUT_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "The floor is gone, but your voice is still in the game.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
...
export const CLIP_HM_BB_BIG_NERVOUS_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Come back to your breath. Come back to your base.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    ...
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Being nervous is energy, not danger. Let it sharpen you. Get low, hold your ground, and meet the first contact with your base.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
  ],
};
...
export const CLIP_HM_BB_BIG_MISSED_FTS_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Those free throws are over. Get back, protect the rim, and stay aggressive.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "You go right back in. Get back, protect the rim, then seal deep and demand the ball. Compete because it's your job, not to get even.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Speak the truth. Two misses are real. They are not the weak-link verdict, and they are not who you are. Reset and go again.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
};
...
export const CLIP_HM_BB_BIG_START_SLOW_SCRIPT: AudioScript = {
  ...
  segments: [
    { type: "speech", text: "Now rehearse the hard moment.", speed: 1.1, mark: { phase: "hardMoment" } },
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "First few minutes and you're a step late to everything. He beats you to his spot. He beats you to the glass. They score twice inside.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    { type: "speech", text: "Feel what your body does. Your steps feel a half-beat behind. A tightness winding across your shoulders. I'm letting them set the tone in the paint.", speed: 1.1, instructions: HARD_MOMENT_NARRATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "The slow start is over. Set the tone from this possession.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "You take the tone back. Establish position early, get the first hit on every box out, and set it from here.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
  ],
};
...
export const CLIP_HM_BB_BIG_FALL_BEHIND_EARLY_SCRIPT: AudioScript = {
  ...
  segments: [
    { type: "speech", text: "Now rehearse the hard moment.", speed: 1.1, mark: { phase: "hardMoment" } },
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "Down ten early. They're scoring in the paint and crashing the offensive glass, and you're the one back there. It feels like the rim is yours to hold and it's slipping.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    { type: "speech", text: "Feel what your body does. The weight of the paint settles on your shoulders. Breath shortening as the lead grows. It's all on me to hold the paint.", speed: 1.1, instructions: HARD_MOMENT_NARRATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Now the reset. Return to your anchor.", speed: 1.1 },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "That run is over. Own this possession.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "You don't carry the scoreboard. You own the next possession. Wall up the rim, contest vertical, secure one rebound. Then the next one.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2.0 },
    { type: "speech", text: "Speak the truth. The deficit is real. The paint is your job, not your worth, and it is not who you are. Reset and go again.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
};
