...
export const CLIP_ST_07_SCRIPT: AudioScript = {
  ...
  postFilter: CLIP_LOUDNORM_FILTER,
  segments: [
    { type: "speech", text: "You are secure. Be brave." },
  ],
};
...
// Canonical text from docs/pregame-scripts.md §4 (FV-136).
// Phase mark: "prayer" on the first speech segment, consistent with PRAYER_SEGMENTS.
