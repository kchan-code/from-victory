...
export const OPENER_BB_HOPE_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    {
      type: "speech",
      text: "So when your legs feel heavy, when the run feels long, when you feel yourself fading — do not quit inside. Hope in the Lord.",
      speed: 1.1,
      instructions: NARRATIVE_INSTRUCTIONS,
    },
    { type: "silence", durationSec: 1 },
    {
      type: "speech",
      text: "Sprint the next lane. Guard the next possession. Trust the One who renews your strength.",
      speed: 1.1,
      instructions: NARRATIVE_INSTRUCTIONS,
    },
    { type: "silence", durationSec: 1 },
