// Defense × I turn the puck over
//
// A D-zone turnover puts the puck behind the goalie's eyes and triggers shame plus the reflex to play tentative on the next breakout.
//
...
export const SESSION_DEFENSE_TURNOVER_SCRIPT: AudioScript = {
  slug: "session-defense-turnover",
  voice: "ash",
