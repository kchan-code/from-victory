...
//
// FV-466: shared sport-neutral variant of opener-hope. Serves every
...
// original opener-hope clip via HOCKEY_OPENER_OVERRIDES in
...
export const OPENER_SHARED_HOPE_SCRIPT: AudioScript = {
  slug: "opener-shared-hope",
  voice: "ash",
  ...
  segments: [
    ...
    {
      type: "speech",
      text: "So when your legs feel heavy, when the day feels long, when you feel like you are running out — do not quit inside. Hope in the Lord.",
      speed: 1.1,
      instructions: NARRATIVE_INSTRUCTIONS,
    },
    { type: "silence", durationSec: 1 },
    {
      type: "speech",
      text: "Take the next step. Push through the next stretch. Trust the One who renews your strength.",
      speed: 1.1,
      instructions: NARRATIVE_INSTRUCTIONS,
    },
    { type: "silence", durationSec: 1 },
