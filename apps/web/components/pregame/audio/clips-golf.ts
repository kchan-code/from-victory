...
export const CLIP_HM_GLF_BOMBER_NERVOUS_SCRIPT: AudioScript = {
  ...
  segments: [
    { type: "speech", text: "Now rehearse the hard moment.", speed: 1.1, mark: { phase: "hardMoment" } },
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "First tee, driver in your hands, people on the bench behind you waiting to play. You stand over the ball and the only thought is the big miss — the snipe left, the block right, in front of everybody.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
...
export const CLIP_HM_GLF_BALLSTRIKER_OB_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "silence", durationSec: 2 },
    { type: "speech", text: "Speak the truth. The wild one is real and it is over. It is not who you are. Tee it up, commit, and play the next shot clean.", speed: 1.1, instructions: HARD_MOMENT_TRUTH_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
  ],
};
...
export const CLIP_HM_GLF_BALLSTRIKER_DUFF_CHIP_SCRIPT: AudioScript = {
  ...
  segments: [
    ...
    { type: "silence", durationSec: 2 },
    { type: "speech", text: "Stop fighting being down here. Pick a landing spot, accept the bogey if it comes, and make one committed stroke with acceleration through the ball.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2 },
...
export const CLIP_HM_GLF_SCRAMBLER_SHORT_PUTT_SCRIPT: AudioScript = {
  ...
  segments: [
    { type: "speech", text: "Now rehearse the hard moment.", speed: 1.1, mark: { phase: "hardMoment" } },
    { type: "silence", durationSec: 0.4 },
    { type: "speech", text: "You've got three feet for par to save the hole. Your bread and butter. You read it, set the line, make your stroke — and it catches the lip and spins out. A short one, the kind you make in your sleep, just lipped out.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 1.5 },
    ...
    { type: "silence", durationSec: 2 },
    { type: "speech", text: "One lip-out doesn't take your stroke. See the line, soft hands, good speed, let it roll. The next short one is a fresh chance to pour it in.", speed: 1.1, instructions: VISUALIZATION_INSTRUCTIONS },
    { type: "silence", durationSec: 2 },
