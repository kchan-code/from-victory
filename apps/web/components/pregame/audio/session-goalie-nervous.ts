// Goalie × I feel nervous
//
// Goalie pre-game nerves are different — alone in the crease, no shift to skate them off. The body has to settle inside the gear before the first shot.
//
...
export const SESSION_GOALIE_NERVOUS_SCRIPT: AudioScript = {
  slug: "session-goalie-nervous",
  voice: "ash",
