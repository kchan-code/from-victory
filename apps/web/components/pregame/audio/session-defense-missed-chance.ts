// Defense × I miss a scoring chance
//
// D-men get fewer chances, so a missed one carries extra weight — the false story is 'I never finish when I get the look.'
//
...
export const SESSION_DEFENSE_MISSED_CHANCE_SCRIPT: AudioScript = {
  slug: "session-defense-missed-chance",
  voice: "ash",
