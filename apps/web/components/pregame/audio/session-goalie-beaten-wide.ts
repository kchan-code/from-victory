// Goalie × I get beaten wide
//
// Lateral breakdown — beat post-to-post on a cross-crease pass. The body wants to overplay the next shot from one side, which opens up the other.
//
...
export const SESSION_GOALIE_BEATEN_WIDE_SCRIPT: AudioScript = {
  slug: "session-goalie-beaten-wide",
  voice: "ash",
