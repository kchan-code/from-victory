...
//
// FV-466: shared sport-neutral variant of opener-be-vocal. Serves every
...
// original opener-be-vocal clip via HOCKEY_OPENER_OVERRIDES in
...
export const OPENER_SHARED_BE_VOCAL_SCRIPT: AudioScript = {
  slug: "opener-shared-be-vocal",
  voice: "ash",
  ...
  segments: [
    ...
    {
      type: "speech",
      text: "So speak. Call it early. Warn them. Encourage them. Let your teammates hear you.",
      speed: 1.1,
      instructions: NARRATIVE_INSTRUCTIONS,
    },
    { type: "silence", durationSec: 1 },
    {
      type: "speech",
      text: "Talking is competing. Your voice shapes the moment before it even arrives. It helps your team win.",
      speed: 1.1,
      instructions: NARRATIVE_INSTRUCTIONS,
    },
    { type: "silence", durationSec: 1 },
    {
      type: "speech",
      text: "Be loud early. Be clear. Be steady. Let your voice set the tone.",
      speed: 1.1,
      instructions: NARRATIVE_INSTRUCTIONS,
    },
    { type: "silence", durationSec: 1 },
