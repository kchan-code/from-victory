// Forward × I get hit
//
// A hard hit on a forward triggers a freeze-or-flinch reflex on the next puck battle — the body wants to avoid the wall, which kills the cycle.
//
...
export const SESSION_FORWARD_GET_HIT_SCRIPT: AudioScript = {
  slug: "session-forward-get-hit",
  voice: "ash",
