// /baseball — baseball marketing landing (FV-506).
// Training, not devotion. Spoken moments are limited to lines the
// baseball audio actually runs (segments-baseball.ts /
// clips-viz-baseball.ts). Server Component.
...
const PAGE_TITLE = "Baseball Visualization Training for Athletes";
const PAGE_DESCRIPTION =
  "See the first pitch before you take the field. Own the mound. Quiet hands. Ages 13+. Compete From Victory.";

export const metadata: Metadata = {
  alternates: { canonical: "/baseball" },
  title: PAGE_TITLE,
  description: PAGE_DESCRIPTION,
  openGraph: {
    type: "website",
    url: `${siteUrl}/baseball`,
...
const whatYouTrain = [
  ...
  },
  {
    ...
    body: "Five minutes, headphones on. You feel the dirt under your cleats. Win the first pitch. Field it clean, soft hands. The hard moment is named. The body knows the cue.",
  },
  {
...
const positions = [
  ...
  {
    title: "Catcher",
    body: "Set up behind the plate, give the target low and away. Receive it quiet, stick the borderline strike. Block everything in the dirt, call each pitch with conviction. The ball comes home \u2014 catch it clean, hold the tag.",
  },
  {
    title: "Infield",
    body: "Take your ready hop as the pitch is released \u2014 weight forward, on the balls of your feet. Field it clean, soft hands, working through it. The tough in-between hop with the runner going still ends in an out.",
  },
  {
    title: "Outfield",
    body: "Jog out to your spot, eyes in on the hitter. Catch it at full speed and come up throwing \u2014 hit the cutoff man clean. The ball into the gap gets read, run down, and played clean off the wall.",
  },
];
    ...
    <>
      ...
      <main id="main-content">
          ...
          <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
            <Reveal>
              ...
              <p className="max-w-[54ch] mb-6 text-cream/70 text-[clamp(16px,1.4vw,19px)] leading-[1.55]">
                You step on the rubber, get your sign, and come set. The
                mound is yours. A catcher sets up behind the plate and sticks
                the borderline strike. An infielder takes the ready hop,
                weight forward. The hard moment is named before it happens.
                Identity in Christ is the ground under that picture. Compete
                From Victory.
              </p>
              <p className="max-w-[54ch] mb-9 text-cream/70 text-[clamp(15px,1.3vw,17px)] leading-[1.55]">
                ...
                lacrosse and soccer (first touch).
              </p>
            ...
            <Reveal>
              <div className="max-w-[760px]">
                ...
                <p className="fv-lede mb-6 max-w-[52ch]">
                  ...
                  slump does not reopen it. You play free because the
                  standing is already settled.
                </p>
        ...
        <section className="py-20 sm:py-24 md:py-32 bg-charcoal border-t border-hairline">
          <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
            <Reveal>
              <SectionMeta num="04" label="For baseball parents" />
            </Reveal>
            <Reveal>
              <div className="grid gap-12 lg:gap-16 items-start grid-cols-1 lg:grid-cols-[1.05fr_0.95fr]">
                <div>
                  <h2 className="fv-h-section mb-6">
                    You already sit behind the backstop. They see the first
                    pitch before they take the field.
                  </h2>
                  <p className="fv-lede mb-8 max-w-[52ch]">
