// /soccer — soccer marketing landing (FV-506).
// Training, not devotion. Spoken moments are limited to lines the
// soccer audio actually runs (clips-viz-soccer.ts / clips-soccer.ts).
// Server Component.
...
const PAGE_TITLE = "Soccer Visualization Training for Athletes";
const PAGE_DESCRIPTION =
  "See the first touch before kickoff. Time the run, stay onside. Hard moment named. Ages 13+. Compete From Victory.";
...
const whatYouTrain = [
  ...
  {
    icon: "zap" as const,
    title: "Pregame on the field",
    body: "Five minutes, headphones on. Kickoff. You check your shoulder as the first pass comes, or you're on the last defender's shoulder timing the run. The hard moment is named. The body knows the cue.",
  },
  {
    icon: "target" as const,
    title: "Pre-practice lock-in",
    body: "Get a ball at your feet and take your first touch with purpose. Scan before you receive. Complete your first pass. Tuesday training uses the same picture as Saturday's kickoff.",
  },
];
...
const positions = [
  {
    title: "Forward",
    body: "Take your spot on the last defender's shoulder. Time the run, stay onside, one touch to set it \u2014 then pass it across into the far corner. The sitter that goes over the bar doesn't write the next chance.",
  },
  {
    title: "Midfielder",
    body: "Check your shoulder as the first pass comes. Receive with a presser on your back, turn out of it with one touch, and play forward into the runner. Give one away? Head up before the next ball arrives.",
  },
  {
    title: "Defender",
  ...
  {
    title: "Goalkeeper",
    body: "Check your posts, set your angle, and organize the back line before the first ball. Call it, come through the traffic, take it cleanly. A soft goal doesn't write the next shot.",
  },
];
    ...
    <>
      ...
      <main>
          ...
          <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
            <Reveal>
              ...
              <p className="max-w-[54ch] mb-6 text-cream/70 text-[clamp(16px,1.4vw,19px)] leading-[1.55]">
                The ball goes over the top. You time the run, stay onside,
                and take one touch to set it. A midfielder checks the
                shoulder as the first pass comes. A keeper checks the posts,
                sets the angle, and organizes the back line. The hard moment
                is named before it happens. Identity in Christ is the ground
              ...
              <p className="max-w-[54ch] mb-9 text-cream/70 text-[clamp(15px,1.3vw,17px)] leading-[1.55]">
                ...
                baseball (first pitch), and lacrosse.
              </p>
            ...
            <Reveal>
              <div className="max-w-[760px]">
                ...
                <p className="fv-lede mb-6 max-w-[52ch]">
                  A 13-year-old starting out wide, a 16-year-old on an
                  academy trial, a 20-year-old fighting for college minutes:
                  the first moment is still a real touch. Identity in Christ
                  is the ground under that picture, not the headline of every
                  paragraph. A cut, a benching, or a goal that was on you
                  does not reopen it. You play free because the standing is
                  already settled.
                </p>
        ...
        <section className="py-20 sm:py-24 md:py-32 bg-charcoal border-t border-hairline">
          <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
            <Reveal>
              <SectionMeta num="04" label="For soccer parents" />
            </Reveal>
            <Reveal>
              <div className="grid gap-12 lg:gap-16 items-start grid-cols-1 lg:grid-cols-[1.05fr_0.95fr]">
                <div>
                  <h2 className="fv-h-section mb-6">
                    You already stand on the touchline. They see the first
                    touch before kickoff.
                  </h2>
                  <p className="fv-lede mb-8 max-w-[52ch]">
