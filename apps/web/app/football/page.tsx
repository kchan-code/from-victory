// /football — football marketing landing (FV-506).
// Training, not devotion. Spoken moments are limited to lines the
// football audio actually runs (segments-football.ts /
// clips-viz-football.ts). Server Component.
...
const PAGE_TITLE = "Football Visualization Training for Athletes";
const PAGE_DESCRIPTION =
  "See the first snap before kickoff. Break the huddle. Hard moment named. Ages 13+. Compete From Victory.";
...
const positions = [
  {
    title: "QB",
    body: "Break the huddle and walk it to the line. The offense is yours. Third and long, blitz coming \u2014 read it pre-snap, slide the protection, find the open man underneath.",
  },
  {
    title: "RB",
    body: "Set in the backfield, eyes on the front. Run downhill, ball secure. Stuffed at the line? Stay patient on the next carry.",
  },
  {
    title: "WR",
    body: "Line up wide, toe on the line. This route is yours. Run it, catch it, finish. Drop one \u2014 finish the next catch.",
  },
  {
    title: "OL",
    body: "Get in your stance, hand in the dirt. This is your phone booth. Protect the man behind you. Lose one, win the next rep.",
  },
  {
    title: "DL",
    body: "Get in your stance across the ball, eyes on the football. You live in their backfield. Get off and win the rep.",
  },
  {
    title: "LB",
    body: "Walk into the box and get everyone lined up. You're the quarterback of this defense. Read your keys, trigger, fill.",
  },
  {
    title: "DB",
    body: "Line up over your man, press alignment, eyes on his hips. This is your island. Press, mirror, play the ball.",
  },
];
    ...
    <>
      ...
      <main id="main-content">
          ...
          <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
            <Reveal>
              ...
              <p className="max-w-[54ch] mb-6 text-cream/70 text-[clamp(16px,1.4vw,19px)] leading-[1.55]">
                You break the huddle and walk it to the line. The offense
                is yours. A receiver lines up wide, toe on the line. A
                linebacker walks into the box and gets everyone lined up. The
                pads settle square on your shoulders. The hard moment is
              ...
              <p className="max-w-[54ch] mb-9 text-cream/70 text-[clamp(15px,1.3vw,17px)] leading-[1.55]">
                ...
                (first possession), golf (first tee), baseball (first
          ...
          <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
            ...
            <Reveal>
              <h2 className="fv-h-section mb-14 max-w-[22ch]">
                See the snap before it happens.
              </h2>
            </Reveal>
            ...
            <Reveal>
              <div className="max-w-[760px]">
                ...
                <p className="fv-lede mb-6 max-w-[52ch]">
                  ...
                  the headline of every paragraph. A pick, a benching, or a
                  mistake on film does not reopen it. You play free because
                  the standing is already settled.
                </p>
        ...
        <section className="py-20 sm:py-24 md:py-32 bg-charcoal border-t border-hairline">
          <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
            <Reveal>
              <SectionMeta num="04" label="For football parents" />
            </Reveal>
            <Reveal>
              <div className="grid gap-12 lg:gap-16 items-start grid-cols-1 lg:grid-cols-[1.05fr_0.95fr]">
                <div>
                  <h2 className="fv-h-section mb-6">
                    You already sit in the stands on Friday night. They see
                    the first snap before kickoff.
                  </h2>
                  <p className="fv-lede mb-8 max-w-[52ch]">
