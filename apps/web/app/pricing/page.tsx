...
const faq: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Hockey, basketball, golf, football, baseball, and lacrosse are live now. More sports are in development — all 30-day training content is sport-specific, so we build each one fully before releasing it.",
  },
  {
  ...
  },
  {
    ...
    a: "From Victory is designed for athletes ages 13 and above. Accounts for athletes under 18 are set up and managed by a parent or guardian, and athletes 13–17 receive additional data protections. Athletes 18 and older can sign up and pay for themselves. The app is not available for users under 13.",
  },
];
              ...
              {[
                {
                  ...
                  body: "30 days of sport-specific mental skill + Scripture foundation. Hockey, basketball, golf, football, baseball, and lacrosse available now.",
                },
                {
                  icon: "zap" as const,
