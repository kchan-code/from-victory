...
const faq: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Hockey, basketball, golf, football, and baseball are live now. More sports are in development — all 30-day training content is sport-specific, so we build each one fully before releasing it.",
  },
  {
              ...
              {[
                {
                  ...
                  body: "30 days of sport-specific mental skill + Scripture foundation. Hockey, basketball, golf, football, and baseball available now.",
                },
                {
                  icon: "zap" as const,
