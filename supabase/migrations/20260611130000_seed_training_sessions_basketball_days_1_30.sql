-- =============================================================================
-- Migration: 20260611130000_seed_training_sessions_basketball_days_1_30.sql
--
-- Purpose (FV-32 — "Basketball daily training content days 1-30"):
--   Seed all 30 days of the From Victory Core Identity Track for basketball
--   into public.training_sessions_catalog, completing the basketball content
--   arc to parity with hockey (hockey days 1-30 were seeded in
--   20260523120000 + 20260605000000, recut in 20260604120000).
--
-- Content arc (mirrors hockey, basketball-adapted):
...
--
-- Authoring:
--   mental_skill_md and journal_prompt authored by content-curator
--   (basketball-expert verified, 2026-06-11; content approved).
--   scripture_ref + scripture_text copied VERBATIM from matching hockey
--   rows (same day_number). title copied VERBATIM from hockey rows.
--   All 30 scripture refs cross-checked draft-vs-hockey: no mismatches.
--   NIV throughout.
--
-- Format (FV-23 locked):
...
--   Days 8 and 9 run two headers on purpose (same as hockey source):
--   Day 8 braids into one movement; Day 9 runs a dual register.
--
-- Idempotency:
...
--   - Journal prompts are single-question, answerable privately, never ask
--     the athlete to disclose to anyone.
...
--     promising outcome reversal. Day 9 keeps the careful dual register
--     (athletic miss vs. moral failure) and is privacy-safe.
-- =============================================================================
...
Every serious hooper knows the voice that takes one mistake and turns it into a verdict. *I'm not a real player. Coach doesn't trust me anymore.* It's fast, and it sounds like the truth. Most of the time it isn't.
...
The worst game you play does not lower your standing with God. The best game you play does not raise it. You don't compete to earn an identity. You compete from one.$session$,
  ...
  $prompt$When did a single mistake on the court last try to tell you who you are, and what would it look like to answer it back?$prompt$
),
...
Every serious hooper lets some voice do the naming — a coach who hasn't run a play for you in three weeks, a scout who closed the notebook, a ranking on a website. That's information. It isn't the verdict on who you are.
...
A program picks you for what you can already do. You were chosen before you'd done anything. No one moved you in by your film, and no one can move you out the same way.$session$,
  'Ephesians 1:4-5',
...
Paul is writing to a church that turned faith into a ranking system. So he asks them: *What do you have that you did not receive?* Every gift you actually have — your hands, your vision, the night your shot was finally falling — came to you. None of it was self-made. So none of it can crown you.

### What you face

This is the quiet trap on the ride home after dropping a career high. The mind takes a big night and makes it the new floor: *this is who I am now.* It feels like confidence. It's a new dependency, and it hands tomorrow's game power over who you are.
...
So when the gym empties out and the only sound is the ball, a drift starts: *does this rep even count if no one sees it?* That question sounds like motivation. It's really about location. Slide toward "not really," and the work has quietly become an audition.
...
The unseen rep is where competing from victory gets built. Your standing came first. The work is what flows from it.$session$,
  ...
  $prompt$What does your effort in the empty gym become when you stop treating it as an audition?$prompt$
),
...
It runs every direction at once — up at the player ahead of you, sideways at the teammate in your spot, down at the one chasing your minutes. Your brain will keep generating the question. You decide whether to answer it. You've been named, restored, and called in Christ. The player above you can't add to that. The one chasing you can't subtract from it.
...
Then lock the phone. Eyes back on the gym you're actually in. You're not on the ranking table. You're following.$session$,
  'John 21:21-22',
...
The warmup line. The stretch you almost skipped. The form-shooting no one filmed. These aren't the throwaway hours of your athletic life. They are your athletic life. Most of who you become gets built here, not on game night.
...
So you can stop performing for yourself. Pick one true sentence about your day. Not flattering. Not condemning. Just accurate: *I worked the warmup hard. I checked out in the third quarter.* No editorial. You're not fixing it. You're letting it be seen.
...
One is the in-game miss — the blown rotation, the lazy pass, the close-out you should have made sooner. After a miss, the mind reaches for one of two dodges: shrink it ("not a big deal") or swell it ("I'm trash"). Both feel like honesty. Neither is. Clean naming loosens the grip.
...
In the car on the way to the gym. The locker room before warmups. Your internal monologue is running, and you haven't noticed what it sounds like. Listen. If it sounds like a job interview — proving you belong, justifying your minutes, earning the next run — you're auditioning. Most hoopers never hear it. They just feel tight and don't know why.
...
You feel it in your hands at the free-throw line with the game close — grip too tight, legs heavy, shooting not to miss. Tight hands brick the shot you're scared to brick. The fear is honest. It just doesn't get to drive.
...
Then loosen the hands and shoot.

You don't play free by feeling safe. You play free because you already are.$session$,
  'Psalm 27:1',
  'The Lord is my light and my salvation— whom shall I fear? The Lord is the stronghold of my life— of whom shall I be afraid?',
  $prompt$Where does fear grip you tightest before you compete — and what would it look like to step to that exact line held instead of afraid?$prompt$
),
...
There's an open look you pass up. You swing it to someone else, safer, because if you miss the big one everyone sees it. So you disappear on purpose and call it smart. That's not discipline. That's fear wearing a disguise.
...
A missed shot is a play. A shot never taken is a verdict you handed to fear. Take it.$session$,
  ...
  $prompt$What's one shot or play you keep passing up because missing it in front of people scares you — and what is that fear actually protecting?$prompt$
),
...
You wait to feel ready before you commit — to the charge, the loose ball, the hard closeout. The feeling rarely arrives first. So you hesitate, and the play passes you by.
...
Courage isn't the absence of fear. It's moving while He's with you, before you feel a thing.$session$,
  ...
  $prompt$When have you waited to feel ready before acting on the floor — and what changed when you moved before the feeling came?$prompt$
),
...
Most of your fear on the floor isn't fear of failing. It's fear of the verdict that comes after.
...
You play stiff because part of you is competing to be approved — by the coach, the scout, the parent in the bleachers. So every possession becomes an audit. That's exhausting, and it's the wrong job.
...
You can risk the loss because the love isn't on the line. It never was.$session$,
  ...
  $prompt$Whose verdict are you playing to earn right now — and what would change if you walked on the floor already certain of God's love?$prompt$
),
...
Late clock, the fear hits — a quick guard attacking you off the bounce, a loose ball squirting your way with the game on the line. There's no time to calm down first. You either trust right there or you freeze.
...
Courage isn't a calm you find before the play. It's trust you choose inside the fear, while the play is still live.$session$,
  ...
  $prompt$Think of a moment fear hit you mid-possession — what would it have looked like to trust God right there, without waiting to feel calm first?$prompt$
),
...
The last set of free throws after a hard practice, legs gone, coach looking elsewhere. The form you could rush, the box-out you could fake. Nobody clocks it but you. That rep is where you're actually built — or quietly cut corners.
...
You can pour everything into a season and still not make the roster, still not get the offer. If the earthly prize is the whole point, that outcome empties the work. It doesn't have to.
...
You're putting in the work and the results are flat. No jump in minutes, no notice from the coach, no obvious payoff. The temptation isn't to blow up. It's to quietly stop trying so hard.
...
Faithfulness in the quiet isn't wasted. The harvest isn't a promised role or more minutes — it's who you're becoming, growing where you can't yet see it.$session$,
  'Galatians 6:9',
...
The brutal conditioning. The role you didn't want — coming off the bench, guarding the other team's best. The hard conversation with a coach. In the moment it feels like you're being singled out, sentenced. That reading turns formation into condemnation.
...
You go hard in practice but scattered — full-speed reps with no focus, chucking shots, sprinting drills fixing nothing, just sweating. It feels like work. At the end you're tired but no better. Effort without a target is just fatigue.
...
The worry loop runs the same three feet of court all night — the matchup, the shot you might brick, what they'll think. Spinning feels like preparing. It isn't. It just wears the same groove deeper.
...
You feel it in how you play to the stands — forcing shots when the scout is courtside, deflating at one disappointed look from the bench. When your worth rides on the room's reaction, every possession becomes a referendum, and you lose the freedom to just hoop.
...
The crowd's verdict shifts every quarter. His doesn't. Play for the approval you already have.$session$,
  'Galatians 1:10',
...
You can only play the possession you're in. Tomorrow's game isn't yours to play yet — so it isn't yours to carry yet either.
...
> *Today's enough. I'll play the possession I'm in.*

Then do the next thing in front of you.

God gives you grace for today. Tomorrow gets its own. Play the possession you're in.$session$,
  'Matthew 6:34',
...
You had the moment and you didn't deliver. The free throws everyone watched rim out. The turnover with the game on the line. Days like that, "shake it off" is an insult — the failure is real and it costs something. You're allowed to feel that fully.
...
A captain's role, starter minutes, seniority — and the pull to lead by status. Barking, ranking, reminding people where they stand on the rotation. That's authority spent on yourself. It builds nothing in the locker room.
...
Paul tells young Timothy not to let his age disqualify him, but notice the answer he gives: *set an example.* He doesn't say "wait until you have seniority." He says your conduct, right now, is the credential. Influence doesn't come from your spot in the rotation. It comes from who you are when people are watching and when they're not.

### What you face

You think leadership is for the captains, the seniors, the starters. So you coast — figure your example doesn't matter yet. But the younger players are already watching how you practice, how you handle a DNP, how you treat people.

### The reset

When you think you're too young or too far down the bench to matter, decide otherwise:
...
You crack the rotation and immediately want the starting spot. Drop 20, and you're already chasing 30. The bar keeps moving, and you never actually arrive. The chase feels like drive. It's really a leak.
...
A bad game, a hard week, and you wake up still carrying it — like today tips off already in the hole, owing something. So you press, trying to make up for yesterday, and you play tight.
