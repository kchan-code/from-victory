...
A daily-discipline, mental-toughness, and Christian faith app for athletes ages 13 and up (calibrated for 13-25) — live for hockey, basketball, golf, football, baseball, lacrosse, and soccer. Parents buy for athletes under 18; adults 18+ can own their own account (self-serve, flag-gated — not yet enabled in production). Identity precedes performance: we operate **from** Christ's victory, not toward it (Hebrews 12:1-2).
