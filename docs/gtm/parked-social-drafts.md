# From Victory - Week 1 Social Re-draft (IG / TikTok native)

*Dated: 2026-07-08 · Re-draft of three rejected assets. Supersedes the deleted LinkedIn JSONs: `fv-crrc-w1-li-reset`, `fv-identity-w1-li-cultural`, `fv-believer-w1-li-leader`.*

> **PARKED - pending schema.** The ContentAsset contract (`schemas/content-asset.schema.json`) only
> enumerates `linkedin | site | community` for `channel`. It has no `instagram` / `tiktok` value yet.
> KC rejected LinkedIn as the wrong channel for From Victory, so these three are re-drafted here as
> IG/TikTok-native copy and held in this draft file until the channel enum is extended. When the enum
> lands, promote each to a ContentAsset JSON with the new channel and `status: awaiting-approval`.
>
> **Why they were rejected (this session):** (1) LinkedIn is the wrong surface for a youth-athlete /
> parent / faith-sports audience. (2) The "settled identity vs. earn one back" line was too literal to
> parse. (3) The visualization truth - the category wedge - was missing from all messaging.
>
> **What changed:** channel recast to IG/TikTok; the abstract identity line shown as concrete behavior;
> the audio-guided visualization woven in as the claim (everyone says visualize, almost no tool helps
> you do it, From Victory does, and you are not doing it alone).
>
> Voice: founder register (hockey dad, plain and observed), verse-led with one passage per piece, not
> pain-first, kc-voice underneath.

---

## Piece 1 - Pregame reset (replaces `fv-crrc-w1-li-reset`, task cnt-001)
...
## Piece 2 - The cultural moment (replaces `fv-identity-w1-li-cultural`, task cnt-002)

*Pillar 1 (faith on the field) · Persona: Caleb / Grace · Format: Reel / TikTok · Reel script: `content/briefs/week1-dropped-pass.md` (the "Faith on the Field" cultural-moment reel)*

**Hook line (first 3s / on-screen):**
> The faith you see after the big play is not a postgame move.

**Caption:**
> Watch any big game this year. The prayer before the snap. The point to the sky. Athletes are more open about their faith than they have been in a long time. Shedeur Sanders prays before every snap. Kids are watching.
>
...
## Piece 3 - The huddle-leader note (replaces `fv-believer-w1-li-leader`, task cnt-004)

*Pillar 3 (built for the believing athlete) · Persona: Coach Marcus · Source brief: `content/briefs/week1-fca-leader-pitch.md`*

> **Channel decision pending (KC):** unlike Pieces 1 and 2, the audience here is huddle leaders and youth
> pastors, not youth athletes, so LinkedIn may actually fit for this one. Both registers are provided.
> KC to choose the surface; if LinkedIn stays, this can go back to a `linkedin` ContentAsset as-is.

**Hook line:**
> Your athletes already read the verse. They do not have a way to run it in the last minute before they compete.

**LinkedIn register (leader / pastor):**
> A note for the huddle leaders and youth pastors.
>
> Your athletes already read the verse. They pray before the game. Then the whistle blows and the game takes over.
>
...
**IG caption register (tighter, founder):**
> A note for the coaches and youth pastors.
>
> Your athletes read the verse. They pray before the game. Then the whistle blows and it is gone.
>
