# From Victory — Ideal Customer Profile (ICP)
...
The trend research sharpens the same point: **own the believing minority, don't dilute to chase the secular middle** (trends.md). Faith framing caps the TAM and that's the feature — it's the wedge no funded incumbent (Calm, Headspace, Hallow) can copy.
...
1. **Competitive scholastic athlete** — active HS (9-12) or NCAA/NAIA/JUCO collegiate competition. Base pool: ~8.8M US scholastic athletes, both HS and NCAA at record highs (NFHS 8,266,244; NCAA 554,298, 2024-25). [Source: NFHS, NCAA]
2. **Age 13+, sweet spot 15-22** — the 13+ floor is a deliberate compliance choice to sidestep the heaviest COPPA verifiable-parental-consent burden (full compliance due 2026-04-22). [Source: buying-process.md / FTC 16 CFR Part 312]
3. **Christian or faith-open and embedded** in a Christian context (church, FCA, Christian school, believing family). Faith is the *qualifier*. Christian share runs ~58% blended across the HS+college cohort (Pew 2023-24), and the base just stabilized after a decade of decline.
4. **Acute identity-performance pain** — confidence tied to results, fear of mistakes, playing tight, faith disconnected from sport.
...
7. **Team/school/church bulk-license buyers as a launch ICP.** B2B2C revenue is unvalidated in the profile — treat these orgs as *distribution and trust*, not the paying customer.
8. **Premium 1:1 human-coaching seekers** ($100-250/session). Different product, different wallet.

## Trigger signals (when a "deal" starts)

A "deal" here is a self-serve B2C subscription decided in minutes, not a B2B cycle (buying-process.md). The trigger is what moves an athlete from waitlist to active habit to paid:
...
- **Wins-testimony moment** — an athlete or coach shares a "competed free, not for approval" story; a referral and social-proof trigger to amplify.

## Personas

The buying process splits **user, payer, and gatekeeper** (buying-process.md). All three must be addressed, but the athlete is the discovery and activation actor.
...
Female HS/college competitive athlete, 15-22, devout, often brings teammates in.
- **Goals:** stop letting performance define her worth; a grounded daily rhythm that fits training, school, and faith; language that takes both faith and sport seriously; a shared, non-shaming team practice.
...
### 4. Coach Marcus — the Faith-Sports Gatekeeper (influencer + channel, not a payer)
FCA/AiA leader, coach, youth pastor, or Christian-school chaplain. Endorses and rolls the app to a roster. Confers faith-fit trust; doesn't pay.
- **Goals:** give athletes a tool that disciples and steadies them; reinforce "from victory, not for victory"; recommend something safe and on-doctrine to families; extend his limited 1:1 time with a daily rhythm athletes carry themselves.
- **Pains:** can't be in every athlete's head on game day; free ministry content is static, secular tools carry no faith; reputation risk recommending an unproven app; sees anxiety he isn't equipped to coach.
...
## Fit rubric (1-5 per dimension, weighted to a 0-100 score)

Sum the five weighted dimensions. **>=80 = priority target · 60-79 = nurture · <60 = de-prioritize or exclude.**

| Dimension (weight) | Score 1 (disqualifying) | Score 3 (marginal) | Score 5 (bullseye) |
|---|---|---|---|
| **Faith fit (30%)** | Secular, no faith interest, bounces on Scripture | Faith-curious / cultural Christian, not devout | Self-identifies Christian, in a Christian community, wants faith woven into sport |
...
## Why this ICP is exclusionary on purpose

The market research is explicit that conversion — not reachable audience — is the binding constraint, and the SOM assumes ~5% free-to-paid vs. the 1-2.3% wellness-app norm (market.md). That lift is only earned by ruthless fit. Every excluded segment above (secular athletes, casual movers, devotional-only readers, free-anchored buyers) is someone who would install, never convert, and drag the average down. The trend research adds the structural reason: the faith framing *caps* TAM and that's the wedge — Calm, Headspace, and Hallow can't follow into "Christian athlete identity training," and the only rival reaching for the same corner (Play With Faith) is still a pre-launch devotional feed, not an identity training system. **Own the believing minority completely; cede the secular middle deliberately.**

## Sources
- Market sizing, conversion benchmark, distribution-vs-market dynamic: `companies/from-victory-app/research/market.md` (NFHS, NCAA, Pew 2023-24, Fact.MR, Market.us, Contrary Research)
- Competitor white space, free-substitute threats, pricing anchors: `companies/from-victory-app/research/competitors.md`
- Athlete mental-health crisis, faith-app tailwinds, retention headwinds, "own the believing minority": `companies/from-victory-app/research/trends.md`
- Buyer/payer/gatekeeper split, trigger events, COPPA / 13+ decision: `companies/from-victory-app/research/buying-process.md`
