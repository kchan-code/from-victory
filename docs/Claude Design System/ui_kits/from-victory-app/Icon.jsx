// From Victory — Icon component. Lucide-style 24x24 line icons, 1.75px stroke.
// Selected/filled variant used only for the active bottom-tab.

const ICONS = {
  home:     'M3 11l9-7 9 7v9a2 2 0 0 1-2 2h-4v-7H9v7H5a2 2 0 0 1-2-2v-9z',
  homeOutline: 'M3 11l9-7 9 7M5 11v9a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-9 M9 22v-7h6v7',
  ...
  journal:  'M5 4h11l3 3v13a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1z M16 4v3h3 M8 11h8 M8 15h6',
...
const FILLED = new Set(['homeFill','flameFill']);
