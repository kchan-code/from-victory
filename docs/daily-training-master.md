# Daily Training — Sport-Agnostic Master (FV-430)

THE canonical prose source for `training_sessions_catalog` (title /
mental_skill_md / journal_prompt; scripture columns live in the original seeds
and never change here). Every sport's rows carry this exact text — edits here
ship as a new UPDATE migration across all rows. Adding a sport = copy any
existing sport's 30 rows. FV-23 format rules apply (≤190 words, header rhythm).

## Day 1 · From Victory, Not Toward It
### body
### The truth
...
### prompt
When did a single mistake last try to tell you who you are, and what would it look like to answer it back?

## Day 2 · You Were Chosen Before Tryouts
### body
### The truth
...
### prompt
Which voice have you been letting name you lately, and what changes if you treat it as information instead of a verdict?

## Day 3 · The Best Game Doesn't Crown You
### body
### The truth
...
### prompt
After your best game, what did you start telling yourself about who you are, and how does "gift, not standing" reframe it?

## Day 4 · Trained Where No One's Watching
### body
### The truth
...
### prompt
What does your effort with no one watching become when you stop treating it as an audition?

## Day 5 · Step Off the Ranking Table
### body
### The truth
...
### prompt
Which direction does comparison pull you hardest — up, sideways, or down — and what would it look like to step off that table today?

## Day 6 · Tuesday Is Holy Ground
### body
### The truth
...
### prompt
Which ordinary, unfilmed part of your training have you been treating as filler, and what shifts when you call it holy ground?

## Day 7 · Come, Don't Earn
### body
### The truth
...
### prompt
Where does rest still feel like falling behind, and what would it take to receive it as restoration instead?

## Day 8 · Fully Known, Fully Held
### body
### The truth
...
### prompt
What is one accurate, un-edited sentence about today — not flattering, not condemning — that you can let simply be seen?

## Day 9 · Grace Meets the Mistake
### body
### The truth
...
### prompt
Where have you been either shrinking or swelling a mistake instead of naming it cleanly, and what would honest naming sound like?

## Day 10 · Sent Out From Delight
### body
### The truth
...
### prompt
When you actually listen to your pregame monologue, does it sound like arriving or auditioning, and what would arriving sound like instead?

## Day 11 · Play Free, You're Held
### body
### The truth
...
### prompt
Where does fear grip you tightest before you compete — and what would it look like to step into that exact moment held instead of afraid?

## Day 12 · Take the Shot
### body
### The truth
...
### prompt
What's one play you keep passing up because missing it in front of people scares you — and what is that fear actually protecting?

## Day 13 · Strength Isn't Felt First
### body
### The truth
...
### prompt
When have you waited to feel ready before acting — and what changed when you moved before the feeling came?

## Day 14 · Loved, So I Can Lose
### body
### The truth
...
### prompt
Whose verdict are you playing to earn right now — and what would change if you stepped into competition already certain of God's love?

## Day 15 · Afraid and Still In
### body
### The truth
...
### prompt
Think of a moment fear hit you mid-play — what would it have looked like to trust God right there, without waiting to feel calm first?

## Day 16 · Small Things, Done Right
### body
### The truth
...
### prompt
Which small, unseen part of your training do you tend to coast through — and who are you becoming each time you do?

## Day 17 · Run to Finish, Not to Win
### body
### The truth
...
### prompt
If a season of your hardest work didn't produce the result you wanted, what would still have made it worth it?

## Day 18 · The Long Obedience
### body
### The truth
...
### prompt
Where are you putting in work that hasn't paid off yet — and what's the temptation when nobody seems to notice?

## Day 19 · Trained by What's Hard
### body
### The truth
...
### prompt
What's hard for you right now that feels like punishment — and how would you face it differently if it were forming you instead?

## Day 20 · Strong, Not Scattered
### body
### The truth
...
### prompt
Where do you go hard without a target — and what one specific thing could each rep actually aim at?
...
### prompt
What weight are you carrying right now that you've never actually handed to God — and what's it costing you to hold it?

## Day 22 · Anxious? Ask, Don't Spiral
### body
### The truth
...
### prompt
What worry have you been spinning on instead of actually praying about — and what would it look like to hand it over tonight?

## Day 23 · Whose Approval Am I After?
### body
### The truth
...
### prompt
Whose reaction in the stands or locker room has the most power over how you feel about yourself — and what does it mean that God's verdict is already settled?

## Day 24 · One Day at a Time
### body
### The truth
...
### prompt
What future moment are you carrying around today that you can't do anything about yet — and what's right in front of you instead?

## Day 25 · My Heart May Fail
### body
### The truth
...
### prompt
When you've genuinely fallen short and it hurt, what does it change to know God was the strength underneath, not just a way to feel better fast?

## Day 26 · Lead by Serving
### body
### The truth
...
### prompt
Where do you tend to lead by status instead of service — and who on your team could you actually lift this week?

## Day 27 · Don't Coast on Your Age
### body
### The truth
...
### prompt
Who's watching how you compete and carry yourself right now — and what example are you actually setting, title or no title?

## Day 28 · Count It, Don't Chase It
### body
### The truth
...
### prompt
What's one thing from today you blew past without noticing because you were already chasing the next thing?

## Day 29 · Mercies for This Morning
### body
### The truth
...
### prompt
What from yesterday are you still carrying into today — and what would it look like to start this morning on grace that's actually new?

## Day 30 · Eyes on the One Who Won
### body
### The truth
...
### prompt
After these thirty days, what's one way you can tell the difference between competing from victory and competing toward it — and where do you still catch yourself doing the second?
